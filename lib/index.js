...
var Zilwrap = /** @class */ (function () {
     ...
     * Check Allowance
     */
    Zilwrap.prototype.checkAllowance = function () {
        // TODO
    };
    /**
     * Check Balance
    ...
    Zilwrap.prototype.checkBalance = function (address) {
        return __awaiter(this, void 0, void 0, function () {
            var state, interestedWallet, hexWalletAddress, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.contract.getSubState("balances")];
                    case 1:
                        state = _a.sent();
                        interestedWallet = "";
    ...
    Zilwrap.prototype.wrap = function (amount) {
        return __awaiter(this, void 0, void 0, function () {
            var amountQa, balance, callTx, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        ...
                        console.log("amountQa: %o", amountQa.toString());
    ...
    Zilwrap.prototype.unwrap = function (tokenAmount) {
        return __awaiter(this, void 0, void 0, function () {
            var burnAmountBN, tokenBalance, tokenBalanceBN, callTx, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
    ...
    Zilwrap.prototype.transfer = function (recipient, amount) {
        return __awaiter(this, void 0, void 0, function () {
            var recipientAddress, transferAmountBN, tokenBalance, tokenBalanceBN, callTx, err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
    ...
    Zilwrap.prototype.transferFrom = function (sender, recipient, amount) {
        return __awaiter(this, void 0, void 0, function () {
            var senderAddress, recipientAddress, transferAmountBN, senderTokenBalance, senderTokenBalanceBN, callTx, err_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        ...
                        recipientAddress = this.sanitizeAddress(recipient);
                        transferAmountBN = new util_1.BN(amount);
                        return [4 /*yield*/, this.checkBalance(senderAddress)];
                    case 1:
                        senderTokenBalance = _a.sent();
                        senderTokenBalanceBN = new util_1.BN(senderTokenBalance);
    ...
    Zilwrap.prototype.increaseAllowance = function (spender, amount) {
        return __awaiter(this, void 0, void 0, function () {
            var spenderAddress, callTx, err_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
    ...
    Zilwrap.prototype.decreaseAllowance = function (spender, amount) {
        return __awaiter(this, void 0, void 0, function () {
            var spenderAddress, callTx, err_7;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
