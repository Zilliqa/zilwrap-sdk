...
var Zilwrap = /** @class */ (function () {
    ...
    Zilwrap.prototype.checkAllowance = function (holder, approvedSpender) {
        return __awaiter(this, void 0, void 0, function () {
            var tokenHolderAddress, state, approvedSpenderAddress, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
    ...
    Zilwrap.prototype.checkBalance = function (address) {
        return __awaiter(this, void 0, void 0, function () {
            var state, interestedWallet, hexWalletAddress, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
    ...
    Zilwrap.prototype.wrap = function (amount) {
        return __awaiter(this, void 0, void 0, function () {
            var amountQa, balance, callTx, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
    ...
    Zilwrap.prototype.unwrap = function (tokenAmount) {
        return __awaiter(this, void 0, void 0, function () {
            var burnAmountBN, tokenBalance, tokenBalanceBN, callTx, err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
    ...
    Zilwrap.prototype.transfer = function (recipient, amount) {
        return __awaiter(this, void 0, void 0, function () {
            var recipientAddress, transferAmountBN, tokenBalance, tokenBalanceBN, callTx, err_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
    ...
    Zilwrap.prototype.transferFrom = function (sender, recipient, amount) {
        return __awaiter(this, void 0, void 0, function () {
            var senderAddress, recipientAddress, spenderAddress, transferAmountBN, spenderAllowance, spenderAllowanceBN, callTx, err_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
    ...
    Zilwrap.prototype.decreaseAllowance = function (spender, amount) {
        return __awaiter(this, void 0, void 0, function () {
            var tokenHolderAddress, spenderAddress, deductAmountBN, spenderAllowance, spenderAllowanceBN, callTx, err_8;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
